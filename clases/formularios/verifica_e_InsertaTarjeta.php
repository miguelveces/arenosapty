...
$mains = new verifica_e_InsertaTarjeta();
$mains->valida_tarjetas_usuario();
...
//echo $_SESSION['usuarios'];
        ...
        $this->codigoTar = strip_tags($_POST["tarjeta"]);//$codigo;
        $this->codverifi = strip_tags($_POST['codverifi']);//$verifica;
        //echo $this->codigoTar;
 ...
 //echo '<script>alert("Esta Tarjeta ya ha sido Registrada en Nuestro Sistema")</script>';
                   ...
                   // $intro = @mysql_query('INSERT INTO tarjetas_por_usuarios( codigo_targeta,codigo_verificador,id_fk_usuario,fecha_registro,Estado_tarjeta,Sellar_tarjeta) values ("' . mysql_real_escape_string($this->codigoTar) . '","' . mysql_real_escape_string($this->codverifi) . '","' . mysql_real_escape_string($this->id) . '","' . mysql_real_escape_string($this->fecha) . '", "' . mysql_real_escape_string($this->estado) . '", "' . mysql_real_escape_string($this->sellar) . '")');
                    ...
                    $intro = @mysql_query('INSERT INTO tarjetas_por_usuarios( codigo_targeta,codigo_verificador,id_fk_usuario,fecha_registro,Estado_tarjeta,Sellar_tarjeta) values ("' . mysql_real_escape_string($this->codigoTar) . '","' . mysql_real_escape_string($this->codverifi) . '","' . mysql_real_escape_string($this->id) . '",UTC_DATE(), "' . mysql_real_escape_string($this->estado) . '", "' . mysql_real_escape_string($this->sellar) . '")');
